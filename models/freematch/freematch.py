    ...
    def train(self, args, logger=None):
        ...
        for (_, x_lb, y_lb), (x_ulb_idx, x_ulb_w, x_ulb_s) in zip(self.loader_dict['train_lb'],
            ...
            with amp_cm():
                ...
                unsup_loss, mask, select, pseudo_lb = consistency_loss(args.dataset,logits_x_ulb_s,logits_x_ulb_w,
                                                    time_p,p_model,
                ...
                # unsup_mce_loss = self.mce_loss(logits_x_ulb_w_masked * 2, logits_x_ulb_s_masked, use_feature=False)
                # print(unsup_mce_loss)

                total_loss = sup_loss + self.lambda_u * (unsup_loss + self.mce_gamma * unsup_mce_loss)
